...
<div class="container">
  ...
  <form action="{{route('user.update', ['user' => $user->id])}}" method="POST">
    ...
    <div class="input-group">
        ...
        <input type="text" value="{{$user->email}}" class="form-control {{$errors->has('email')? 'border-danger' : '' }}" id="inlineFormInputGroupUsername" name="email" placeholder="">
    </div>
    <br>
    <div class="input-group">
        <div class="input-group-prepend">
    ...
    <div class="input-group">
        ...
        <input type="password"  class="form-control {{$errors->has('password')? 'border-danger' : '' }}" id="inlineFormInputGroupUsername" name="password_confirmation" placeholder="password_confirmation">
    </div>
    <br>
    <div class="input-group">
        <div class="input-group-prepend">
